...
const SocialBox: FC = () => {
  return (
    <div className="flex flex-wrap gap-4 mt-4 justify-center">
      <Link href="https://twitter.com/jwest951227" passHref target="_blank">
        <div className="grid w-10 h-10 p-2 rounded-3xl place-content-center shadow-item dark:shadow-none dark:bg-white">
          <TwitterIcon />
        </div>
      </Link>
      <Link href="https://github.com/jwest951227" passHref target="_blank">
        <div className="grid w-10 h-10 p-2 rounded-3xl place-content-center shadow-item dark:shadow-none dark:bg-white">
          <GithubIcon />
        </div>
      </Link>
      ...
      <Link href="https://t.me/jwest951227" passHref target="_blank">
